package com.cafeconpalito.jwt.security.service;

import com.cafeconpalito.jwt.repository.UserRepository;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        com.cafeconpalito.jwt.entities.User user = userRepository.findByUsername(username)
